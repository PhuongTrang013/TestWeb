    ...
    var e = $("#m_login"),
        ...
        s = function () {
            $("#m_login_signup_submit").click(function (a) {
                ...
                //    n.ajaxSubmit({
                //    url: "~/Agency/PropertyAgency/IndexAgency",
                ...
                //            i(a, "success", "Chúc mừng. Bạn đã tạo tài khoản thành công.")
                //        }, 2e3)
                //    }
                //    }))
            })
        }, o = function () { $("#m_login_forget_password_submit").click(function (a) { a.preventDefault(); var r = $(this), n = $(this).closest("form"); n.validate({ rules: { email: { required: !0, email: !0 } } }), n.valid() && (r.addClass("m-loader m-loader--right m-loader--light").attr("disabled", !0), n.ajaxSubmit({ url: "", success: function (a, l, s, o) { setTimeout(function () { r.removeClass("m-loader m-loader--right m-loader--light").attr("disabled", !1), n.clearForm(), n.validate().resetForm(), t(); var a = e.find(".m-login__signin form"); a.clearForm(), a.validate().resetForm(), i(a, "success", "Mật khẩu đã được gửi đến địa chỉ email của bạn!") }, 2e3) } })) }) }; return { init: function () { n(), l(), s(), o() } }
